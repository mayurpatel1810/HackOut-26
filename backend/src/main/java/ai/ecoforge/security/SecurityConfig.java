...
public class SecurityConfig {
    ...
    private final EcoForgeProperties props;

    public SecurityConfig(EcoForgeProperties props) { this.props = props; }
    ...
    public CorsConfigurationSource corsSource() {
        ...
        config.setAllowedOrigins(props.getSecurity().getCorsOrigins());
